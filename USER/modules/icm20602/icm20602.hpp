...
#ifndef __ICM20602_HPP
#define __ICM20602_HPP
...
#define MPU_WHOAMI_20602_1		0x12
#define MPU_WHOAMI_20602_2		0x2E
...
class ICM20602 :public SPI,LED
{
public:
	ICM20602(SPI_TypeDef *h,char *n,char *s,GPIO_TypeDef *gpiox,uint32_t Pin) : hspi(h),name(n),DirChr(s),led(gpiox,Pin){};
	~ICM20602(){}
...
private:
	...
	sensor_acc_msg acc;
	downsample_imu_for_eskf_msg downsample_imu;
	int sample_cnt;
